...
return(
    <>
     <div className=" px-4 text-gray-100  sm:pt-20 pb-20">
            <div className=" container flex flex-col lg:flex-row gap-y-6 justify-between mx-auto ">
                <div className=" flex  gap-4">
                    ...
                    <div>
                        ...
                        <div className=" text-gray-100">Concerts par an.</div>
                    </div>
                ...
                <div className=" flex gap-4 ">
                    ...
                    <div>
                        ...
                        <div className=" text-gray-100">Rapide et facile.</div>
                    </div>
                ...
                <div className=" flex gap-4">
                    ...
                    <div>
                        ...
                        <div className=" text-gray-100">Sûr et garanti.</div>
                    </div>
